...
using System.IO;
/// <summary>
/// SQLSERVER Restif interface. Use SQLServer authentication.
/// </summary>
namespace RestifD
{
    class Restif
    {
        ...
        static void Main(string[] args)
        {
            ...
            listener.Prefixes.Add("http://" + host + ":8178/");
            listener.Prefixes.Add("https://"+host+":4438/");
            listener.Realm = "SqlServer on " + host;
            ...
            Task.Run(() =>
             {
                ...
                var connstring = "Data Source=" + host + ";Persist Security Info=True;User ID=" + s[0]+";Password="+s[1];
                if (db != null)
        ...
        void SendCORS()
        {
            ...
            c.AddHeader("Access-Control-Allow-Origin", origin);
            c.AddHeader("Access-Control-Allow-Headers", h);
            c.AddHeader("Access-Control-Allow-Methods", "GET, POST, PUT, DELETE, OPTIONS");
            c.AddHeader("Access-Control-Max-Age", "86400");
            c.ContentLength64 = 0;
